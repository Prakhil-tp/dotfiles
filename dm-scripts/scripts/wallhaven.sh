...
APIKEY="FLvDnTNoIEfrrp7lS2IFFEcwIpw9Wrzg"
#####################################
...
LOCATION=/home/prakhil/Pictures/backgrounds
...
# speed improvements
# using this option can lead to cloudflar blocking some of the downloads
PARALLEL=0
